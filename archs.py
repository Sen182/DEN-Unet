...
class SEACBNet(nn.Module):
    def __init__(self, dropout_rate=0.2):
        super(SEACBNet, self).__init__()
        ...
        self.block1 = SEACB(32, 16, 1, 1, 3, dropout_rate)
        self.block2 = SEACB(16, 24, 6, 2, 3, dropout_rate)
        self.block3 = SEACB(24, 40, 6, 2, 5, dropout_rate)
        self.block4 = SEACB(40, 80, 6, 2, 3, dropout_rate)
...
class DENUNet(nn.Module):
    ...
    def forward(self, input):
        ...
        eff_features = self.SEACBNet(input)
